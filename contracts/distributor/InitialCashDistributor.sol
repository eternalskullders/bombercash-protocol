...
import '../distribution/SACDAIPool.sol';
import '../distribution/SACBACPool.sol';
import '../distribution/SACUSDCPool.sol';
import '../distribution/SACUSDTPool.sol';
import '../distribution/SACESDPool.sol';
import '../distribution/SACFRAXPool.sol';
import '../distribution/SACAETHPool.sol';
...
contract InitialCashDistributor is IDistributor {
    ...
    constructor(
        ...
        require(_pools.length != 0, 'a list of SAC pools are required');
